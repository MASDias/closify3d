...
/* harmony import */ var _scene_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scene.component */ "./src/app/scene.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _scene_component__WEBPACK_IMPORTED_MODULE_4__["SceneComponent"],
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
            ],
...
class Armario extends three__WEBPACK_IMPORTED_MODULE_0__["Group"] {
    ...
    constructor(largura, altura, profundidade) {
        ...
        var floorMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshLambertMaterial"]({
            map: new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]().load('wood.png'),
...
class Cabide extends three__WEBPACK_IMPORTED_MODULE_0__["Group"] {
    constructor() {
        ...
        var pegaMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshLambertMaterial"]({
            map: new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]().load('wood3.jpg'),
            side: three__WEBPACK_IMPORTED_MODULE_0__["DoubleSide"]
        });
        ...
        // Barra
        var barraGeometry = new three__WEBPACK_IMPORTED_MODULE_0__["CylinderGeometry"](0.25, 0.25, 10, 30);
...
class Gaveta extends three__WEBPACK_IMPORTED_MODULE_0__["Group"] {
    constructor(largura, altura, profundidade) {
        ...
        var floorMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshLambertMaterial"]({
            map: new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]().load('wood4.jpg'),
            side: three__WEBPACK_IMPORTED_MODULE_0__["DoubleSide"]
        });
        var floorCube = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](floorGeometry, floorMaterial);
...
class Porta extends three__WEBPACK_IMPORTED_MODULE_0__["Group"] {
    constructor() {
        ...
        // Front
        var frontGeometry = new three__WEBPACK_IMPORTED_MODULE_0__["BoxGeometry"](10, 10, 1);
        var frontMaterial = new three__WEBPACK_IMPORTED_MODULE_0__["MeshLambertMaterial"]({
            map: new three__WEBPACK_IMPORTED_MODULE_0__["TextureLoader"]().load('wood3.jpg'),
            side: three__WEBPACK_IMPORTED_MODULE_0__["DoubleSide"]
        });
        var frontCube = new three__WEBPACK_IMPORTED_MODULE_0__["Mesh"](frontGeometry, frontMaterial);
...
var SceneComponent = /** @class */ (function () {
    ...
    SceneComponent.prototype.initFloor = function () {
        var texture = new three__WEBPACK_IMPORTED_MODULE_5__["TextureLoader"]().load('floor.jpg', function (texture) {
    ...
    SceneComponent.prototype.initObjects = function () {
        ...
        var gaveta = new _model_gaveta__WEBPACK_IMPORTED_MODULE_6__["Gaveta"](10, 4, 11);
        armario.add(gaveta);
        gaveta.position.x = -15;
        gaveta.position.y = 5.5;
        //gaveta.position.z = 1;
        var porta = new _model_porta__WEBPACK_IMPORTED_MODULE_7__["Porta"]();
        armario.add(porta);
        porta.position.y = 8.5;
        porta.position.z = 1;
        var cabide = new _model_cabide__WEBPACK_IMPORTED_MODULE_3__["Cabide"]();
        armario2.add(cabide);
...
module.exports = __webpack_require__(/*! E:\isep\3_ano\1_sem\sgrai\SGRAI_18_19\otherstuff\src\main.ts */"./src/main.ts");
